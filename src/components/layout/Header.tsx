    ...
    <>
      ...
      >
        <div className="container-site">
          <div className="flex items-center justify-between h-[130px] md:h-[150px]">
            ...
            >
              <Image
                ...
                height={1024}
                priority
                className="h-[130px] md:h-[150px] w-auto transition-all duration-300"
                style={{ filter: "none" }}
              />
            </Link>
            ...
            <div className="flex items-center gap-4">
              ...
              <Link
                href="/contact"
                className="hidden md:inline-flex items-center gap-2 text-sm font-medium tracking-widest uppercase rounded px-5 py-2.5 transition-all duration-300 hover:opacity-80"
                style={{
