...
const paragraphs = [
  ...
  "Backed by over 35 years of textile expertise, we combine advanced manufacturing, innovative product development, and a deep understanding of evolving fashion trends to create fabrics that meet the highest standards of quality, performance, and design.",
...
const leadership = [
  {
    ...
    description:
      "With over 35 years in the textile industry, Vipul has built Linen Mantra into a trusted name for premium linen manufacturing — known for unwavering quality and deep technical knowledge.",
  },
  {
    name: "Shrey Raichura",
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 lg:gap-14 items-start">
        ...
        <div className="lg:col-span-3">
          <FadeInOnScroll direction="up">
            ...
            >
              <span className="block">Built on Craft.</span>
        ...
        <FadeInOnScroll direction="left" delay={0.2} className="lg:col-span-2">
          <div className="sticky top-[178px] flex flex-col gap-4">
